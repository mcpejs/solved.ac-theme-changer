...
let solved=['rgb(161, 228, 172)','rgb(120, 203, 148)','rgb(78, 177, 124)','rgb(0, 121, 80)']
...
function removeZeroSolved(){
    document.querySelectorAll(`[fill="rgb(221, 223, 224)"]`).forEach(e=>e.remove())
}

function inject(){
    const colorSettingButton='<a class="setting" style="right: 35px;position: absolute;cursor:pointer">테마 설정</a>'
    document.querySelectorAll(".borJCn")[1].insertAdjacentHTML('beforeend',colorSettingButton)
